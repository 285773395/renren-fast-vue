  ...
  <nav class="site-navbar" :class="navbarClasses">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">恒天然安满产品扫描系统</a>
        <a class="site-navbar__brand-mini" href="javascript:;">恒天然安满产品扫描系统</a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        <el-submenu index="3">
          <template slot="title">百度一下</template>
          <el-menu-item index="2-1"><a href="//github.com/" target="_blank">1</a></el-menu-item>
          <el-menu-item index="2-2"><a href="//git.oschina.net/" target="_blank">2</a></el-menu-item>
          <el-menu-item index="2-3"><a href="//git.oschina.net/" target="_blank">3</a></el-menu-item>
        </el-submenu>
